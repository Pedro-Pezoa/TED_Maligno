...
int main(int argc, _TCHAR* argv[])
{
	...
	{
		cout << endl << "BOT> HashTable padrao selecionada" << endl;
		hash = HashTable<string, int>();
		cout << "BOT> Operador de crescimento: fatorial(!) Tamanho: 4!; Quantidade maxima de dados: 50% da hashtable Tamanho maximo das listas: 3; ";
	}
